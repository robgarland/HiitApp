...
"""
image = '/assets/Workoutlogowhite.png'

def Navbar():
     navbar = dbc.Navbar([dbc.Col(html.Img(src=image, height="50eh")),
...
def Navbar2():
     navbar2 = dbc.Navbar([dbc.Col(html.Img(src=image, height="50eh"))
                          ], color = '#0A455A', sticky = 'top',dark = True)
     return navbar2
...
submitbutton = dbc.Button('Submit',id = 'submit-button', n_clicks = 0, className="mr-auto", style = {'textAlign' : "center", 'display':'block','margin-top':'30px', 'width':'36vw','touch-action': 'manipulation','background-color':'#71CC97','border-color':'#71CC97'})

abutton = dbc.Button('A',id = 'a-button',n_clicks=0, color = 'info', className="ml-auto", style = {'textAlign' : "center", 'display':'block', 'margin-top':'30px', 'width':'36vw', 'height':'18vh', 'font-size':'40px','touch-action': 'manipulation','background-color':'#0A4F69','border-color':'#0A4F69','border-radius':'10%'})

bbutton = dbc.Button('B',id = 'b-button',n_clicks=0, color = 'info', className="mr-auto", style = {'textAlign' : "center", 'display':'block','margin-top':'30px','width':'36vw','height':'18vh','font-size':'40px','touch-action': 'manipulation','background-color':'#0A4F69','border-color':'#0A4F69','border-radius':'10%'})
...
def update_instructor_workout(index, newstate, code):
    ...
    if screentype == 'inputs':
        ...
        if newstate == 'Exercise':
            headerlayout = [html.H6(children = ['AB Challenge'], style = {'textAlign' : "center",'margin-top':'0px','margin-bottom':'0px','background-color':'#5AC4D8','padding':'30px'}),
                        html.H4(children = [exercisetype], style = {'textAlign' : "center",'margin-top':'0px','color':'#71CC97','padding':'30px'}),
                        ]
            ...
            headerlayout = [html.H6(children = ['AB Challenge'], style = {'textAlign' : "center",'margin-top':'30px',}),
...
def update_workout(code,name):
    ...
    if screentype == 'inputs':
        ...
        headerlayout = [html.H6(children = [structure['leaderboard']['index'][index]['Exercise']], style = {'textAlign' : "center",'margin-top':'0px','margin-bottom':'0px','background-color':'#FFD700','padding':'30px'})]
        ...
        if state == 'Exercise':
            headerlayout = [html.H6(children = ['ABB Challenge'], style = {'textAlign' : "center",'margin-top':'0px','margin-bottom':'0px','background-color':'#5AC4D8','padding':'30px'}),
                            html.H4(children = [exercisetype], style = {'textAlign' : "center",'padding-top':'50%','margin-bottom':'0px','padding-bottom':'70%','color':'#FFFFFF','background-color':'#71CC97','font-size':'35px'})
                            ]
            mainlayout = [update_exercise_interval]
            scorelayout = []
        elif state == 'Rest':
            if sessioninfo[code]['Participants'][partindex]['Scores'][index]['Answered'] == 1 and sessioninfo[code]['Participants'][partindex]['Scores'][index]['Score'] > 0:
                headerlayout = [html.H6(children = ['ABB Challenge'], style = {'textAlign' : "center",'margin-top':'0px','background-color':'#5AC4D8','padding':'30px'}),
                                html.H4(children = ['Rest 😎'], style = {'textAlign' : "center",'margin-top':'30px','color':'#5AC4D8','font-size':'30px'}),
        ...
        options = structure['abcdinput']['index'][index]['Options']
        if state == 'Exercise':
            headerlayout = [html.H6(children = ['Workout Buddies'], style = {'textAlign' : "center",'margin-top':'0px','margin-bottom':'0px','background-color':'#5AC4D8','padding':'30px'}),
                            html.H4(children = [exercisetype], style = {'textAlign' : "center",'padding-top':'50%','padding-bottom':'70%','margin-bottom':'0px','color':'#FFFFFF','background-color':'#71CC97','font-size':'35px'})
                            ]
            mainlayout = [update_exercise_interval]
            scorelayout = []
        ...
        if state == 'Exercise':
            headerlayout = [html.H6(children = ['Intense Burst 💪'], style = {'textAlign' : "center",'margin-top':'0px','margin-bottom':'0px','background-color':'#EFEFEF','padding':'30px'}),
                            html.H4(children = [exercisetype], style = {'textAlign' : "center",'padding-top':'50%','margin-bottom':'0px','padding-bottom':'70%','color':'#FFFFFF','background-color':'#71CC97','font-size':'35px'})]
            mainlayout = [update_exercise_interval]
            scorelayout = []
        elif state == 'Rest':
